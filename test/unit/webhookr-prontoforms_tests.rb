...
describe Webhookr::Prontoforms::Adapter do
  ...
  describe "the class" do
    ...
    subject { Webhookr::Prontoforms::Adapter }
  ...
  describe "the instance" do
    ...
    subject { Webhookr::Prontoforms::Adapter.new }
  ...
  describe "it's response" do
    before do
      @event_type = "unsubscribe"
      @adapter = Webhookr::Prontoforms::Adapter.new
    end
    ...
    it "should return the correct service name" do
      assert_equal(Webhookr::Prontoforms::Adapter::SERVICE_NAME, subject.service_name)
    end
